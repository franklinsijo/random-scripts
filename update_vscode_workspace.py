...
for d in os.listdir(ABSOLUTE_WORKSPACE_DIRECTORY):
    if os.path.isdir(os.path.join(ABSOLUTE_WORKSPACE_DIRECTORY, d)):        
        CURRENT_DIRECTORIES.append({'name': d, 'path': d})
...
# nohup fswatch -od -l 60 /Users/frankojis/Github/ | xargs -n1 /Users/frankojis/Github/random-scripts/update_vscode_workspace.py &
